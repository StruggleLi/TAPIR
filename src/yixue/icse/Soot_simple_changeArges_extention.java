...
public class Soot_simple_changeArges_extention {
    ...
    public static void main(String[] args) {
        ...
        PackManager.v().getPack("jtp").add(new Transform("jtp.internalTransform", new BodyTransformer() {
            @Override
            protected void internalTransform(final Body b, String phaseName, @SuppressWarnings("rawtypes") Map options) {//这一行是系统自己增加的，和非extention存在小差别
                System.out.println("Instrument method:"+b.getMethod().getName());
                InsertDecodingLog2(b);//success--改造完成
    ...
    /********************The following function method are used to add code in a method body********************/
