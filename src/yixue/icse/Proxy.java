...
//	}
	...
	public static void printeTimeStamp(String sig){
	...
	public static void printTimeDiff(String body, String sig, long timeDiff){
		...
		System.out.println("printTimeDiff:"+timeDiff+"   "+"getTimeStamp:"+String.valueOf(time)+"nanoTime: "+String.valueOf(natime));
	}
	public static void printMemoryUsage(String body, String sig, long memoryUsage){
		System.out.println(body+"###"+sig+"###"+memoryUsage);
		System.out.println("printMemoryUsage(m1+m2):"+memoryUsage);
	...
	public static long getMemoryUsage(){
		System.out.println("getMemoryUsage--m1:"+(Runtime.getRuntime().totalMemory()));
