...
//	public final static HashMap<String, DefSpot> defSpotMap = new HashMap<String, DefSpot>(); //body is the key
	...
	final static String ProxyClass = "main.java.yixue.icse.Proxy";
...
//	final static String getContentNew = "java.lang.Object getContent(java.net.URLConnection)";
	...
	final static String printMemoryUsage = "void printMemoryUsage(java.lang.String,java.lang.String,long)";
	final static String printOutUrl = "void printOutUrl(java.lang.String,java.lang.String,java.lang.String)";
	final static String getTimeStamp = "long getTimeStamp()";
	final static String getUrlStr = "java.lang.String getUrlStr()";//千万不要直接用String,会报错

	final static String getMemoryUsage = "long getMemoryUsage()";
	...
	final static String returnBigUrl = "java.lang.String returnBigURL(java.lang.String)";//java.lang.String
