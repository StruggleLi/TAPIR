...
//	public static ArrayList<String> trans_str= new ArrayList<String>();
	...
	public static void main(String[] args) throws IOException{
		...
		//String path = "F:\\APK1"; // 路径
		//String path = "C:\\Users\\Dell\\Downloads\\APK"; // 路径
		//getFileName(path);
		
		//将分析的.apk的名字写入到文件中，便于记录到表格。
//		String filenameSet="";
...
//				
//		}
//		writeToFile(filenameSet,"D:\\TransF\\filename1.txt");
		

		//tran。bat中的.APK向JAR转换
//		String path1="D:\\TransF\\tran1.bat";
//		getStrFordex2Jar(path1);

		if(figer2==1){
		//获得转换后的Jar文件名列表
//		getJarName();   //处理路径：D:\\transf\\Jar
//		unpressJar();   //File jarFile = new File("D:\\transf\\Jar\\"+jarname.get(i));
...
//		}
	...
	public static void getStrFordex2Jar(String path) throws IOException{
		...
		for(int i=0;i<filename.size();i++){
			...
			str=str+"call d2j-dex2jar.bat  F:\\APK\\"+filename.get(i)+"\r\n";
	...
	public static void getStr_Jar() throws IOException{
