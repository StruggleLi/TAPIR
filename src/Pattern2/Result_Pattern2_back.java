...
public class Result_Pattern2_back {
	//Pattern2检测统计元素
		public ArrayList<ArrayList<String>> UI_method=new ArrayList<ArrayList<String>>();  //存储每个decode相关的UI方法
		public ArrayList<ArrayList<String>> child_method=new ArrayList<ArrayList<String>>();  //存储每个decode相关的child方法
